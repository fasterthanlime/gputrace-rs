// Ported from gputrace-go/internal/counter/file_mapping.go.
// Counters_f_N.raw maps to this CSV-order table at index N - 4.
pub(crate) const ALL_COUNTER_NAMES: &[&str] = &[
